...
# while True: で無限に繰り返す
while True:
    # CdS センサーの ADC 値（0〜4095）を読み取って表示する。明るいほど値が小さく、暗いほど値が大きくなる
    print("CdS value          :", adc2.read())

    # 土壌水分センサーの ADC 値（0〜4095）を読み取って表示する。土が乾いているほど値が大きく、濡れているほど値が小さくなる
    print("Soil moisture value:", adc1.read())
